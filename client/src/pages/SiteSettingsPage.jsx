...
const SiteSettingsPage = () => {
    ...
    const [settings, setSettings] = useState({
      heroImage: '', heroTitle: '', heroSubtitle: '', aboutTitle: '', aboutText: '',
      aboutImage1: '', aboutImage2: '', videoUrl: '', videoTitle: '', videoText: '',
      contactEmail: '', contactPhone: '', instagramUrl: '', facebookUrl: '', twitterUrl: '',
    });
    ...
    const uploadFileHandler = async (e) => {
      ...
      try {
        ...
        setSettings(prevSettings => ({ ...prevSettings, [fieldName]: data.image }));
      } catch (error) {
        console.error(error);
        alert('Upload failed.');
      } finally {
    ...
    return (
      <div className="pt-24 container mx-auto px-4">
        ...
        <form onSubmit={submitHandler} className="space-y-8">
          ...
          <button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded">
            Save Settings
          </button>
        </form>
      </div>
